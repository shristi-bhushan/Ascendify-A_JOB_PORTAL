<%@ Page Title="" Language="C#" MasterPageFile="~/User/UserMaster.Master" AutoEventWireup="true" CodeBehind="JobDetails.aspx.cs" Inherits="Ascendify.User.JobDetails" %>
            ...
            <div class="container gap-10">
                <asp:DataList ID="DataList1" runat="server" OnItemCommand="DataList1_ItemCommand" OnItemDataBound="DataList1_ItemDataBound">
                    ...
                    <div class="col-xl-7 col-lg-6">
                        <!-- job single -->
                        <div class="single-job-items-default-page mb-50 w-auto">
                            <div class="job-items">
                        ...
                        <div class="job-post-details w-75">
