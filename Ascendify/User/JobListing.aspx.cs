...
{ 
    public partial class JobListing : System.Web.UI.Page
    {
        ...
        protected void CheckBoxList1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                con = new SqlConnection(str);
                string query = @"Select JobId,Title, Salary, JobType, Companyname, Country, State, 
        ...
        public string selectedRadioButton()
        {
            ...
            else if (RadioButtonList1.SelectedValue == "2")
            {
                postedDate = "between Convert(DATE,'" + DateTime.Now.AddDays(-2).ToString("yyyy/MM/dd") + "') "
                              + "and Convert(DATE,'" + date.ToString("yyyy/MM/dd") + "')";
            }
            ...
            {
                postedDate = "between Convert(DATE,'" + DateTime.Now.AddDays(-10).ToString("yyyy/MM/dd") + "') "
                              + "and Convert(DATE,'" + date.ToString("yyyy/MM/dd") + "')";
            }
            return postedDate;
        }
        ...
        protected void lbFilter_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (isCondition)
                {
                    ...
                    query = @"Select JobId,Title, Salary, JobType, Companyname, Country, State, 
