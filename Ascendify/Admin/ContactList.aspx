<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="ContactList.aspx.cs" Inherits="Ascendify.Admin.ContactList" %>
                ...
                <div class="col-md-12"> 
                    <asp:GridView ID="GridView1" runat="server" CssClass="table table-hover table-bordered"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="Name" HeaderText="User Title">
                            <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
