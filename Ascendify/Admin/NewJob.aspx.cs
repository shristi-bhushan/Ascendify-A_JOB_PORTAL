            ...
            try
            {
                ...
                if (Request.QueryString["id"] != null)
                {
                    ...
                    if (DateTime.TryParse(txtLastDate.Text.Trim(), out lastDate))
                    {
                        ...
                        cmd.Parameters.AddWithValue("@CompanyImage", ""); // Add empty value for now
                        ...
                        {
                            lblMsg.Visible = true;
                            lblMsg.Text = "Cannot save the record right now. Please try again later.";
                            lblMsg.CssClass = "alert alert-danger";
                        }
                    }
                }
                else
                {
                    ...
                    if (DateTime.TryParse(txtLastDate.Text.Trim(), out lastDate))
                    {
                        ...
                        {
                            lblMsg.Visible = true;
                            lblMsg.Text = "Cannot1" + type + "the record right now. Please try again later.";
                            lblMsg.CssClass = "alert alert-danger";
                        }
                    }
                    else
                    ...
                    if (isValidToExecute)
                    {
                        ...
                        {
                            lblMsg.Visible = true;
                            lblMsg.Text = "Cannot saved the record right now, please try after sometime..!";
                            lblMsg.CssClass = "alert alert-danger";
                        }
                    }
            }
