<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="NewJob.aspx.cs" Inherits="Ascendify.Admin.NewJob" %>
        ...
        <div class="container pt-4 pb-4">
            ...
            <div class="row mr-lg-5 ml-lg-5 mb-3">
                <div class="col-md-6 pt-3">
                    ...
                    <asp:TextBox ID="txtJobTitle" runat="server" CssClass="form-control" required placeholder="Ex. Web Developer, App Developer">
                    </asp:TextBox>
                </div>
                <div class="col-md-6 pt-3">
            ...
            <div class="row mr-lg-5 ml-lg-5 mb-3">
                <div class="col-md-6 pt-3">
                    ...
                    <asp:TextBox ID="txtQualification" runat="server" CssClass="form-control" placeholder="Ex. BTech, MBA, MCA" required>
                    </asp:TextBox>
                </div>
                <div class="col-md-6 pt-3">
                    <label for="txtExperience" style="font-weight: 600">Experience Required</label>
                    <asp:TextBox ID="txtExperience" runat="server" CssClass="form-control" placeholder="Ex: 1 year, 1.5 years" required>
                    </asp:TextBox>
                </div>
            </div>
            ...
            <div class="row mr-lg-5 ml-lg-5 mb-3">
                <div class="col-md-6 pt-3">
                    ...
                    <asp:TextBox ID="txtSpecialization" runat="server" CssClass="form-control" placeholder="Enter Specialization" required
                        TextMode="MultiLine">
                    </asp:TextBox>
                </div>
                <div class="col-md-6 pt-3">
            ...
            <div class="row mr-lg-5 ml-lg-5 mb-3">
                <div class="col-md-6 pt-3">
                    ...
                    <asp:TextBox ID="txtSalary" runat="server" CssClass="form-control" placeholder="Ex: 25000/Month, 7 LPA" required>
                    </asp:TextBox>
                </div>
                <div class="col-md-6 pt-3">
            ...
            <div class="row mr-lg-5 ml-lg-5 mb-3">
                <div class="col-md-12 pt-3">
                    ...
                    <asp:TextBox ID="txtAddress" runat="server" CssClass="form-control" placeholder="Enter Work Location" required
                        TextMode="MultiLine">
                    </asp:TextBox>
                </div>
            </div>
            ...
            <div class="row mr-lg-5 ml-lg-5 mb-3">
                <div class="col-md-6 pt-3">
                    ...
                    <asp:DropDownList ID="ddlCountry" runat="server" required DataSourceID="SqlDataSource1" CssClass="form-control w-100"
